...
class Polygon {
    ...
    addVertex(x, y) {
        ...
        if (this.vertices.length > 1) {
            ...
            const lineMaterial = new THREE.LineBasicMaterial({ color: 0x2ecc71 });
    ...
    finalizePolygon() {
        ...
        const material = new THREE.MeshBasicMaterial({ color: 0xff8c00, side: THREE.DoubleSide });
        ...
        const edgeMaterial = new THREE.LineBasicMaterial({ color: 0x8e44ad });
